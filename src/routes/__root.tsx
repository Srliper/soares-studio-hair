  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-display gold-gradient">404</h1>
        <p className="mt-4 text-muted-foreground">Página não encontrada.</p>
        <Link to="/" className="mt-6 inline-block text-primary underline">Voltar</Link>
      </div>
    </div>
  );
}
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{if(localStorage.getItem('high-contrast')==='1'){document.documentElement.classList.add('high-contrast');}}catch(e){}})();`,
          }}
        />
      </head>
